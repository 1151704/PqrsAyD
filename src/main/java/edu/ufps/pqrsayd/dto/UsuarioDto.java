...
public class UsuarioDto implements Serializable {
    ...
    public TipoIdentificacionDto getTipoIdentificacion() {
        return new Service().serviceTipoIdentificacion().buscarPorId(this.fkTipoIdentificacion);
    }

    public TipoUsuarioDto getTipoUsuario() {
        return new Service().serviceTipoUsuario().buscarPorId(this.fkTipoUsuario);
    }
