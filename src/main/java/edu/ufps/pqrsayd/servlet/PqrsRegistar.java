...
import edu.ufps.pqrsayd.util.ArchivoSubir;
            ...
            while (it.hasNext()) {
                ...
                if (isFormField) {
                    switch (fileItem.getFieldName()) {
                        case "tipo_usuario":
                            idTipoUsuario = Utilidades.validateInputNumber(fileItem.getString("UTF-8"));
                            break;
                        case "tipo_identificacion":
                            idTipoIdentificacion = Utilidades.validateInputNumber(fileItem.getString("UTF-8"));
                            break;
                        case "codigo_interno":
                            codigoInterno = Utilidades.validateInputNumber(fileItem.getString("UTF-8"));
                            break;
                        case "tipo_solicitud":
                            idTipoSolicitud = Utilidades.validateInputNumber(fileItem.getString("UTF-8"));
                            break;
                        case "motivo_solicitud":
                            idMotivo = Utilidades.validateInputNumber(fileItem.getString("UTF-8"));
                            break;
                        case "celular":
                            celular = Utilidades.validateInputText(fileItem.getString("UTF-8"));
                            break;
                        case "correo":
                            correo = Utilidades.validateInputText(fileItem.getString("UTF-8"));
                            break;
                        case "direccion":
                            direccion = Utilidades.validateInputText(fileItem.getString("UTF-8"));
                            break;
                        case "telefono":
                            telefono = Utilidades.validateInputText(fileItem.getString("UTF-8"));
                            break;
                        case "descripcion":
                            descripcion = Utilidades.validateInputText(fileItem.getString("UTF-8"));
                            break;
                        case "primer_nombre":
                            nombre1 = Utilidades.validateInputText(fileItem.getString("UTF-8"));
                            break;
                        case "segundo_nombre":
                            nombre2 = Utilidades.validateInputText(fileItem.getString("UTF-8"));
                            break;
                        case "primer_apellido":
                            apellido1 = Utilidades.validateInputText(fileItem.getString("UTF-8"));
                            break;
                        case "segundo_apellido":
                            apellido2 = Utilidades.validateInputText(fileItem.getString("UTF-8"));
                            break;
                        case "identificacion":
                            identificacion = Utilidades.validateInputText(fileItem.getString("UTF-8"));
                            break;
                    }
                } else {
                    archivo = fileItem;
